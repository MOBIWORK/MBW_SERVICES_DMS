  ...
  return n.prototype.getDoc = function(e, t) {
    ...
    return Fe(this, void 0, void 0, function() {
      ...
      return Ue(this, function(b) {
        return s = {}, t && (i = t.fields, o = t.filters, c = t.orFilters, l = t.orderBy, a = t.limit, h = t.limit_start, f = t.groupBy, p = t.asDict, m = p === void 0 ? true : p, g = l ? "".concat(String(l == null ? void 0 : l.field), " ").concat((r = l == null ? void 0 : l.order) !== null && r !== void 0 ? r : "asc") : "", s = {
...
function xi() {
  ...
  ar = 1;
  var n = ae;
  return Xt = n.isStandardBrowserEnv() ? /* @__PURE__ */ function() {
    return {
      write: function(r, s, i, o, c, l) {
        var a = [];
        a.push(r + "=" + encodeURIComponent(s)), n.isNumber(i) && a.push("expires=" + new Date(i).toGMTString()), n.isString(o) && a.push("path=" + o), n.isString(c) && a.push("domain=" + c), l === true && a.push("secure"), document.cookie = a.join("; ");
      },
      read: function(r) {
...
function so() {
  ...
  var n = hs(), e = ft, t = ht, r = dt, s = Ke, i = function() {
    function o(c, l, a) {
      var h, f;
      this.url = c, this.name = a != null ? a : "FrappeApp", this.useToken = (h = l == null ? void 0 : l.useToken) !== null && h !== void 0 ? h : false, this.token = l == null ? void 0 : l.token, this.tokenType = (f = l == null ? void 0 : l.type) !== null && f !== void 0 ? f : "Bearer", this.axios = (0, s.getAxiosClient)(this.url, this.useToken, this.token, this.tokenType);
    }
...
function uo() {
  return kr || (kr = 1, function() {
    ...
    var i = typeof Object.is == "function" ? Object.is : s, o = n.useState, c = n.useEffect, l = n.useLayoutEffect, a = n.useDebugValue, h = false, f = false;
    function p(k, y, M) {
...
async function gs(...n) {
  ...
  const a = i.revalidate !== false, h = (m) => typeof c == "function" ? c(m) : c !== false, f = i.throwOnError;
  if (Oe(t)) {
...
var qo = (n, e, t) => {
  const { cache: r, compare: s, suspense: i, fallbackData: o, revalidateOnMount: c, revalidateIfStale: l, refreshInterval: a, refreshWhenHidden: h, refreshWhenOffline: f, keepPreviousData: p } = t, [m, g, b, E] = Te.get(r), [_, S] = $n(n), k = (0, import_react.useRef)(false), y = (0, import_react.useRef)(false), M = (0, import_react.useRef)(_), T = (0, import_react.useRef)(e), V = (0, import_react.useRef)(t), D = () => V.current, j = () => D().isVisible() && D().isOnline(), [L, Q, ne, G] = ps(r, _), F = (0, import_react.useRef)({}).current, Le = C(o) ? t.fallback[_] : o, Qe = (N, U) => {
    ...
    const N = (() => !_ || !e ? false : C(c) ? D().isPaused() || i ? false : C(l) ? true : l : c)(), U = (J) => {
      const de = De(J);
  ...
  ), Ze[0], Ze[1]), et = !k.current, yt = m[_] && m[_].length > 0, we = be.data, Ee = C(we) ? Le : we, Ne = be.error, mt = (0, import_react.useRef)(Ee), Ie = p ? C(we) ? mt.current : we : Ee, Ve = (() => yt && !C(Ne) ? false : et && !C(c) ? c : D().isPaused() ? false : i ? C(Ee) ? false : l : C(Ee) || l)(), je = !!(_ && e && et && Ve), $e = C(be.isValidating) ? je : be.isValidating, tt = C(be.isLoading) ? je : be.isLoading, ve = (0, import_react.useCallback)(
    async (N) => {
      const U = T.current;
...
function Bt(n, e) {
  ...
  const t = va(n, e.path || "/socket.io"), r = t.source, s = t.id, i = t.path, o = it[s] && i in it[s].nsps, c = e.forceNew || e["force new connection"] || e.multiplex === false || o;
  let l;
...
` + R[W].replace(" at new ", " at ");
    ...
    function Is(u, d) {
      if (typeof u.ref == "string" && Pe.current && d && Pe.current.stateNode !== d) {
        ...
        Wt[v] || (S('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', G(Pe.current.type), u.ref), Wt[v] = true);
      }
    }
    function Vs(u, d) {
      {
        ...
        v.isReactWarning = true, Object.defineProperty(u, "key", {
          get: v,
          configurable: true
        });
      }
    ...
    function js(u, d) {
      {
        ...
        v.isReactWarning = true, Object.defineProperty(u, "ref", {
          get: v,
          configurable: true
        });
      }
...
Check the top-level render call using <` + v + ">.");
    ...
    function zs(u, d, v) {
      return nr(u, d, v, true);
    }
    function Ks(u, d, v) {
      return nr(u, d, v, false);
    }
    var Gs = Ks, Xs = zs;
...
var qa = (n) => {
  ...
  const {
    ...
    ...n
  }), p = (0, import_react.useCallback)(async (g) => t.loginWithUsernamePassword(g).then((b) => (o(), b)), []), m = (0, import_react.useCallback)(async () => t.logout().then(() => f(null)).then(() => i(null)), []);
  return {
...
var ja = () => {
  const {
    db: n
  } = (0, import_react.useContext)(te), [e, t] = (0, import_react.useState)(false), [r, s] = (0, import_react.useState)(null), [i, o] = (0, import_react.useState)(false), c = (0, import_react.useCallback)(() => {
...
var Ha = (n) => {
  const {
    call: e
  } = (0, import_react.useContext)(te), [t, r] = (0, import_react.useState)(null), [s, i] = (0, import_react.useState)(false), [o, c] = (0, import_react.useState)(null), [l, a] = (0, import_react.useState)(false), h = (0, import_react.useCallback)(() => {
    r(null), i(false), c(null), a(false);
  }, []);
  return {
    call: (0, import_react.useCallback)(async (p) => (c(null), a(false), i(true), r(null), e.post(n, p).then((m) => (r(m), i(false), a(true), m)).catch((m) => {
      throw i(false), a(false), c(m), m;
    })), []),
    result: t,
    loading: s,
    error: o,
...
var Ja = (n) => {
  ...
  return {
    call: (0, import_react.useCallback)(async (p) => (c(null), a(false), i(true), r(null), e.put(n, p).then((m) => (r(m), i(false), a(true), m)).catch((m) => {
      throw i(false), a(false), c(m), m;
    })), []),
    result: t,
    loading: s,
...
var Ya = (n) => {
  ...
  return {
    call: (0, import_react.useCallback)(async (p) => (c(null), a(false), i(true), r(null), e.delete(n, p).then((m) => (r(m), i(false), a(true), m)).catch((m) => {
      throw i(false), a(false), c(m), m;
    })), []),
    result: t,
    loading: s,
...
var za = () => {
  const {
    file: n
  } = (0, import_react.useContext)(te), [e, t] = (0, import_react.useState)(0), [r, s] = (0, import_react.useState)(false), [i, o] = (0, import_react.useState)(null), [c, l] = (0, import_react.useState)(false), a = (0, import_react.useCallback)(async (f, p, m) => (h(), s(true), n.uploadFile(f, p, (g, b) => t(Math.round(g / b * 100)), m).then((g) => (l(true), t(100), s(false), g.data.message)).catch((g) => {
