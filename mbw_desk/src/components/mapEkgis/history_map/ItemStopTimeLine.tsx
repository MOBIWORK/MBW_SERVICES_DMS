...
export function ItemStopTimeLineContent({ data, onEventClickItem }: { data: DataStopTimeLine, onEventClickItem: any }){
    ...
    return <>
        ...
        <div style={{height: '20px', width: '20px', marginLeft: '5px', marginRight: '5px'}} className="flex items-center justify-center">
            ...
            <div style={{color: '#637381', fontWeight: 400, fontSize:'14px', lineHeight: '21px'}}>{data.time_stop}</div>
        </div>
        <div className="flex" style={{marginTop: '5px'}}>
            <div style={{height: '20px', width: '20px', marginLeft: '5px', marginRight: '5px'}} className="flex items-center justify-center">
