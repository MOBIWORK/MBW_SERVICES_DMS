...
export function  ItemEndTimeLineDot(){
    return <>
        <div style={{height:'36px', width:'36px', borderRadius:'32px', border:'1px solid #DFE3E8', gap:'8px'}} className="flex items-center justify-center">
            <div style={{width: '20px', height: '20px', backgroundSize: 'Cover'}} className='icon_ending'></div>
        </div>
    </>
}
...
export function ItemEndTimeLineContent({ data, onEventClickItem }: { data: DataEndTimeLine, onEventClickItem: any }){
    ...
    return <>
        ...
        <div style={{height: '20px', width: '20px', marginLeft: '5px', marginRight: '5px'}} className="flex items-center justify-center">
            ...
            <div style={{color: '#637381', fontWeight: 400, fontSize:'14px', lineHeight: '21px'}}>{data.time_end}</div>
        </div>
        <div className="flex" style={{marginTop: '5px'}}>
            <div style={{height: '20px', width: '20px', marginLeft: '5px', marginRight: '5px'}} className="flex items-center justify-center">
