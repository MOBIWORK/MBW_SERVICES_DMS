...
function WidgetHistory({ employee }: { employee?: string }) {
  ...
  useEffect(() => {
    ...
    //   widgetScript.src = 'https://files.ekgis.vn/sdks/tracking/v2/ekmapplf-history-map.min.js';
    //   widgetScript.async = true;
    //   document.body.appendChild(widgetScript);
    //   widgetScript.onload = () => {
    //     new window.ekmapplf_Tracking.HistoryMap().init('map_history_1',
    //       {apiKey: 'w1Dlh2wRon7mE6sL196TgvLS45fw02uon74pJ0rc', projectId: '6556e471178a1db24ac1a711', objectId: '', date: '2024-08-03'})
    //       .then(data => {
    //         // Phương thức trả ra dữ liệu lịch sử nếu cần
