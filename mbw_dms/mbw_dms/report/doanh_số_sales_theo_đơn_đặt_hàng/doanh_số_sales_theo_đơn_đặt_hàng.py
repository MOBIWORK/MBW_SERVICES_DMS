...
def execute(filters=None):
	...
	for d in entries:
		if d.total_stock_qty > 0 or filters.get("show_return_entries", 0):
			data.append(
				[	d.sales_person,
					d.customer,
					d.posting_date,
...
def get_entries(filters):
	...
	entries = frappe.db.sql(
		"""
		SELECT
			dt.name, dt.customer, dt.{} as posting_date,
