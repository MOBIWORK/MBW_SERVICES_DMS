...
class Analytics:
	...
	def get_sales_transactions_based_on_order_type(self):
		...
		list_territory = frappe.get_list("Territory", filters={"parent_territory": "Z2 Vĩnh Long"}, fields=["name"])
		territory_names = [d["name"] for d in list_territory]
		...
		self.entries = (
			...
			.where(
				...
				& (doctype.territory.isin(territory_names))
