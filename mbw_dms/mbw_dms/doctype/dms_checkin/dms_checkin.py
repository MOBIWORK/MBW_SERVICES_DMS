...
def create_checkin_image(body):
    try:
        ...
        customer_code = validate_filter(type_check='require',value=(body.get('customer_code'),"customer code"))
        customer_name = validate_filter(type_check='require',value=(body.get('customer_name'), "customer name"))
        address = body.get('address')
        long = validate_filter(type_check='require',value=(body.get('long'),"long"))
        lat = validate_filter(type_check='require',value=(body.get('lat'),"lat"))
