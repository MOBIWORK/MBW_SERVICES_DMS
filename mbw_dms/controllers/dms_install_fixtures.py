...
def install(country=None):
	records = [
		...
		{"doctype": "Custom HTML Block","__newname": "DMS Router Web" ,"html": ('<h4 style="font-size:16px;font-weight: 600;">Chức năng chính</h4><div class="content" style="margin-bottom: 10px;"><a class="text" href="/mbw_desk/router-control">Quản lý tuyến</a></div><div class="content" style="margin-bottom: 10px;"><a class="text" href="/mbw_desk/monitor-album">Chấm điểm trưng bày</a></div><div class="content" style="margin-bottom: 10px;"><a class="text" href="/mbw_desk/monitor-album">Bản đồ khách hàng</a></div><div class="content" style="margin-bottom: 10px;"><a class="text" href="/mbw_desk/monitor-album">Giám sát viếng thăm khách hàng</a></div><div class="content" style="margin-bottom: 10px;"><a class="text" href="/mbw_desk/monitor-album">Giám sát thực hiện KPI (Nhân Viên)</a></div>')}
	]
