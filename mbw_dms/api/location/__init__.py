...
def list_district(ma_tinh):
    try:
        ...
        list_districts = frappe.db.get_list('DMS District', filters={'ma_tinh_thanh': validate_not_none(ma_tinh)}, fields=['ma_huyen', 'ten_huyen', 'ma_tinh_thanh'], order_by='ma_huyen asc')
...
def list_ward(ma_quan_huyen):
    try:
        list_wards = frappe.db.get_list('DMS Ward', filters={'ma_quan_huyen': validate_not_none(ma_quan_huyen)}, fields=['ma_xa', 'ten_xa', 'ma_quan_huyen'], order_by='ma_xa asc')
